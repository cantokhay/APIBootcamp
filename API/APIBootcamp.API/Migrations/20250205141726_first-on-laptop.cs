...
{
    public partial class firstonlaptop : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChefFullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChefTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChefComment = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReservationFullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ReservationPeopleCount = table.Column<int>(type: "int", nullable: false),
